...
# ./cmd/api/main.go: The path to your main package for the API server application.
RUN CGO_ENABLED=0 GOOS=linux go build -ldflags="-s -w" -o /go/bin/api ./cmd/api/main.go
